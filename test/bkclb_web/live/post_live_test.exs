defmodule BkclbWeb.PostLiveTest do
  use BkclbWeb.ConnCase

  import Phoenix.LiveViewTest

  alias Bkclb.BookClub

  @create_attrs %{body: "some body", parent_id: 42, username: "some username"}
  ...
  defp fixture(:post) do
    {:ok, post} = BookClub.create_post(@create_attrs)
    post
  end
